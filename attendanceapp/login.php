...
<body>
    <div class="loginform">
    <div class="text-gray-900" align="center">
    <h2><b>STUDENT ATTENDANCE SYSTEM : IT Database-2</b></h2><br>
    <img src="img/logo/edge.jpg" style="width:100%;height:100px"><br>
    <h3 class="h4 text-gray-900 mb-4">Admin Login Panel</h3>
